...
exports.postAuth = async (req, res, next) => {
  ...
  if (code) {
    ...
    axios
      .post(
        `https://id.twitch.tv/oauth2/token?client_id=rggrr0wfq2zb6m42yvki7hzi71x7jn&client_secret=jd97lkc9whxdicjg2xdpq2h3mn7ir2&code=${code}&grant_type=authorization_code&redirect_uri=exp://25.22.61.204:19000`
      )
      .then((response1) => {
        axios({
          method: "get",
